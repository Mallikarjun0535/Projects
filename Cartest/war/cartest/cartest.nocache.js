...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cartest" because\n';
  ...
  $wnd.__gwt_activeModules['cartest'] = {
    'moduleName' : 'cartest',
    'bindings' : function() {
      return {};
    }
 ...
 * "/cartest.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cartest'].superdevmode = true;

  var expectedSuffix = '/cartest.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cartest + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cartest';
  var devModeSessionKey = '__gwtDevModeSession:cartest';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cartest/cartest.nocache.js';
  ...
  $wnd.__gwt_activeModules['cartest'].canRedirect = true;
  $wnd.__gwt_activeModules['cartest'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cartest?user.agent=' + ua + '&_callback=' + callback;
